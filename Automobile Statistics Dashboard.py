...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, values='Advertising_Expenditure', names='Vehicle_Type', title='Total Advertisement Expenditure by Each Vehicle Type'))
